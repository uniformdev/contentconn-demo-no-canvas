...
import { IWhyAttend } from '../lib/contentstack';
...
export const WhyAttend = ({ title, description, image }: WhyAttendProps) => (
  <section className="bg-white border-b py-8">
    ...
    >
      {image ? (
        <div className="w-1/2">
          <img src={image.url} alt={title} width={400} height={400} loading="lazy" className="p-10" />
        </div>
      ) : null}
      <div className="w-1/2">
        <div className="p-10">
